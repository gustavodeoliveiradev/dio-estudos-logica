...
for (let i = 1; i <= quantidadeGolpes; i++) {
    ...
    // para garantir que o índice esteja dentro do tamanho do array
    let minaIndex = (i - 1) % minerais.length;

    // TODO: Agora exiba o índice i, concatene com o caractere ":", após,
    // concatene com tipo de minerais[minaIndex]:
